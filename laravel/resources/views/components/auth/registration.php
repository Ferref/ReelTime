<form name="reg-form" class="d-flex gap-3 flex-column">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" name="email_confirmed" id="email_confirmed" placeholder="confirm email" required>
  </div>
  <div class="form-group">
  ...
  <button type="submit" class="my-1 btn btn-primary">Register</button>
</form>